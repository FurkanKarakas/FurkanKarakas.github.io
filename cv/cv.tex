...
\begin{multicols}{2}
  ...
  \cvitem{Date of Birth}{\emph{24\textsuperscript{th} August, 1995}}
  \cvitem{Birthplace}{Istanbul}
  \cvitem{Address}{Quartier Pré-Fontaine 48, 1023 Crissier, Switzerland}
  \cvitem{Mobile}{+41 77 915 99 35}
  \cvitem{E-Mail}{\href{mailto:furkan.karakas@epfl.ch}{furkan.karakas@epfl.ch}}
  \cvitem{Personal Website}{\href{https://furkankarakas.github.io/}{https://furkankarakas.github.io/}}
  \cvitem{GitHub}{\href{https://github.com/FurkanKarakas}{https://github.com/FurkanKarakas}}
  \cvitem{LinkedIn}{\href{https://www.linkedin.com/in/furkan-karakas/}{https://www.linkedin.com/in/furkan-karakas/}}
...
\cvitem{}{Looking for master's thesis positions in:}
\cvlistitem{distributed computing,}
%\cvlistitem{networking,}
\cvlistitem{cryptography and security, or}
...
\cvitem{Jul 2020 -- Jan 2021}{\textbf{ABB Corporate Research Center} \textit{Baden, Switzerland} -- Student Internship} 
\cvlistitem{Worked on a project to store the values generated by IoT sensors in a blockchain platform in a secure fashion}
...
\cvitem{Aug 2019 -- Jan 2020}{\textbf{Albert Solino Consultancy} \textit{California, USA} \href{https://albertsolinocorp.com/}{https://albertsolinocorp.com/} -- Junior Web Application Developer}
...
\cvitem{Apr 2019 -- Jul 2019}{\textbf{Arçelik Global} \textit{Istanbul, Turkey} \href{https://www.arcelikglobal.com/en/}{https://www.arcelikglobal.com/en/} -- Project Assistant}
...
\cvitem{Jun 2018 -- Sep 2018}{\textbf{CAX-SERVICE GmbH Software-Engineering \& Messtechnik} \textit{Munich, Germany} \href{http://www.cax-service.org/}{http://www.cax-service.org/} -- Part-time Working Student}
...
\cvitem{Feb 2018 -- Mar 2018}{\textbf{Accelera Software and Consultancy} \textit{Istanbul, Turkey} \href{http://www.accelera.com.tr/contact/}{http://www.accelera.com.tr/contact/} -- Internship}
...
\cvitem{}{Basic knowledge of container technologies (Docker and docker-compose)}
\cvitem{}{Basic knowledge of Linux-based OS (Ubuntu)}
